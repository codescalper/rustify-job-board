const placeholderJobs = [
  {
    title: "Rust Backend Developer at Stripe",
    type: "Full-time",
    companyName: "Stripe",
    locationType: "Remote",
    ...
    slug: "rust-backend-developer-at-stripe-1",
    salary: 150000,
    approved: true,
    description: `
  **About Stripe**
  ...
  **Job Description**
  ...
  As a Rust Backend Developer at Stripe, you will be working on cutting-edge technology to build and maintain scalable, efficient, and reliable software solutions. You'll collaborate with a team of talented engineers, designers, and product managers to deliver exceptional user experiences.
  ...
  **Qualifications**
  ...
  - Proficiency in Rust programming language and TypeScript.
  - Experience with front-end technologies such as React, Angular, or Vue.js.
  - Familiarity with server-side frameworks like Actix, Rocket, or Warp.
  ...
  **Benefits**
  ...
  {
    title: "Rust Backend Developer at Vercel",
    type: "Full-time",
    companyName: "Vercel",
    locationType: "Hybrid",
    location: "San Francisco, California, United States",
    ...
    slug: "rust-backend-developer-at-vercel-2",
    salary: 120000,
    approved: true,
    description: `
  **About Vercel:** 
  ...
  **Qualifications:**
  ...
  -   Strong proficiency in Rust programming language and TypeScript, including DOM manipulation and the JavaScript object model.
  -   Experience with front-end frameworks such as React.js and its core principles.
  ...
  **Benefits:**
  ...
  {
    title: "Rust Backend Developer at OpenAI",
    type: "Part-time",
    companyName: "OpenAI",
    locationType: "On-site",
    location: "San Francisco, California, United States",
    applicationUrl: "https://openai.com/apply",
    slug: "rust-backend-developer-at-openai-3",
    salary: 250000,
    approved: true,
    description: `
  **About OpenAI:**
  ...
  **Job Description:**
  ...
  We are seeking a skilled Rust Backend Developer to join our innovative team. In this role, you'll contribute to the development and optimization of the ChatGPT platform, focusing on backend systems that power conversational AI. You'll collaborate with a talented team of researchers, engineers, and product managers to enhance ChatGPT's capabilities and scalability.
  ...
  **Qualifications:**
  ...
  -   Strong experience in backend development, particularly with Rust and TypeScript.
  ...
  **Benefits:**
  ...
  {
    title: "Rust Backend Developer at Coding in Flow",
    type: "Internship",
    companyName: "Coding in Flow",
    locationType: "Remote",
    applicationUrl: "https://codinginflow.com",
    slug: "rust-backend-developer-at-coding-in-flow-4",
    salary: 500,
    approved: true,
    description: `
  ...
  {
    title: "Rust Backend Developer at SmartDiary.co",
    type: "Contract",
    companyName: "SmartDiary.co",
    locationType: "Remote",
    applicationUrl: "https://smartdiary.co",
    slug: "rust-backend-developer-at-smartdiary-co-5",
    salary: 30000,
    approved: true,
    description: `
  ...
  {
    title: "Rust Backend Developer at Microsoft",
    type: "Temporary",
    ...
    slug: "rust-backend-developer-at-microsoft-6",
    salary: 180000,
    approved: true,
    description: `
        **About Microsoft:**
        ...
        Job Description: We are looking for a talented and dedicated Rust Backend Developer Contractor to contribute to Microsoft's dynamic and diverse projects. In this role, you will be responsible for developing and maintaining software applications, collaborating with various teams to bring innovative solutions to life. This is a contract position with the potential for future long-term opportunities.
        ...
        **Qualifications:**
        ...
        -   Proven experience as a Rust Backend Developer, with a strong background in software development.
        -   Proficiency in Rust programming language and TypeScript.
  ...
  {
    title: "Rust Backend Developer at Apple",
    type: "Full-time",
    companyName: "Apple Inc.",
    locationType: "Hybrid",
    location: "Cupertino, California, United States",
    applicationUrl: "https://apple.com/apply",
    slug: "rust-backend-developer-at-apple-7",
    salary: 200000,
    approved: true,
    description: `
        **About Apple:**
        ...
        **Qualifications:**
        ...
        -   Strong experience in Rust Backend Development, particularly in languages like Rust and TypeScript.
  ...
  {
    title: "Rust Backend Developer at Shopify",
    type: "Part-time",
    companyName: "Shopify",
    locationType: "Hybrid",
    ...
    slug: "rust-backend-developer-at-shopify-8",
    salary: 90000,
    approved: true,
    description: `
        **About Shopify:**
        ...
        **Job Description:**
        ...
        We are looking for a part-time Rust Backend Developer to join our development team. This role is ideal for someone who is passionate about web development, eager to learn, and looking to gain extensive experience in a dynamic e-commerce environment. You will be assisting in the development and maintenance of Shopify's web-based projects and collaborating with experienced developers.
        ...
        **Qualifications:**
        ...
        -   Basic understanding of web development technologies, including HTML, CSS, JavaScript, and at least one server-side language (e.g., Rust).
